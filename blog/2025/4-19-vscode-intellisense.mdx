...
![GitLens](/img/blogs/vscode-intellisense/current-line-blame.png)
...
- [CfxLua IntelliSense](https://marketplace.visualstudio.com/items?itemName=ihyajb.cfxlua-intellisense)
