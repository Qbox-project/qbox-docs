...
Make sure to read the [Developer's Guide](./developers) to learn about principles that make you avoid bad practices and help you in having a better developer experience.
