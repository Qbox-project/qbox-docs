...
description: This document provides comprehensive documentation for client-side events within the Qbox Core framework. It outlines both non-networked and networked events that are triggered on the client, offering details on their purpose, usage, and any associated data structures (types).
