...
description: Documentation for shared library functions in the qbx_core resource. These functions provide common utilities for string manipulation, math operations, table handling, and vehicle-related functionality that can be used on both client and server sides.
