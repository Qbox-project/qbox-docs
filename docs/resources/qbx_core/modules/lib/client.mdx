...
description: Documentation for client-side library functions in the qbx_core resource. These functions provide utilities for drawing text, handling entities, managing vehicles, and playing audio within the Qbox framework.
---
